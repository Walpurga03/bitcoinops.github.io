...
- **BIP-Entwurf zum Teilen von Block-Templates:** Anthony Towns
  ...
  Templates bis etwas mehr als doppelt so groß wie das aktuelle
  Blockgewichtslimit.
...
- [Eclair #3103][] führt Unterstützung für [Simple Taproot Channels][topic simple taproot channels]
  ...
  nicht zu unterscheiden. Das PR enthält auch Unterstützung für [Dual Funding][topic dual funding]
